...
setup(
    ...
    name='poatools',
    version='0.0.0',
    description='Poatools',
    python_requires='==3.*,>=3.6.1',
    project_urls={
        "documentation": "https://poatools.readthedocs.io",
        "homepage": "https://github.com/sjin09/poatools",
        "repository": "https://github.com/sjin09/poatools"
    },
    author='Sangjin Lee',
    author_email='sjin.lee09@gmail.com',
    license='MIT',
    classifiers=[
    ...
    entry_points={"console_scripts": ["poatools = poatools.__main__:main"]},
    packages=['poatools'],
    package_dir={"": "src"},
    package_data={"poatools": ["*.typed"]},
    install_requires=[
        'argparse==1.*,>=1.4.0', 'click==7.*,>=7.0.0', 'pyabpoa==1.*,>=1.2.5',
        'pyfastx==0.*,>=0.8.4'
    ],
    extras_require={
        "dev": [
